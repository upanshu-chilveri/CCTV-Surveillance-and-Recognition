...
Training Script
---------------
Trains ReIDNet on DukeMTMC-ReID using:
  • Cross-Entropy loss   (ID classification)
  • Triplet loss         (metric learning, hard mining)
  • Warm-up LR schedule  → Cosine annealing
  • TensorBoard logging
  • Best-model checkpointing

Run:
  python train_reid.py --data_root /path/to/DukeMTMC-reID --epochs 120
"""
